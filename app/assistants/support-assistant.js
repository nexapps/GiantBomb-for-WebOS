...
_APP_Support_Email = {
  address: "support@nexapps.net",
	subject: "("+Mojo.appInfo.version+")"
}

// Optional
_APP_Publisher_URL = "http://www.nexapps.net";
...
SupportAssistant.prototype.setup = function(){
	...
	this.controller.setupWidget(Mojo.Menu.appMenu, this.attributes = {
		omitDefaultItems: true
		  ...
		  items: [Mojo.Menu.editItem, {label: "Help", command: Mojo.Menu.helpCmd, disabled: true}]
		}
	)
